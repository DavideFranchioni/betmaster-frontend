  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        back:
          "bg-back text-white hover:bg-back-dark shadow-sm",
        lay:
          "bg-lay text-white hover:bg-lay-dark shadow-sm",
        gold:
          "bg-brand-accent text-brand-primary hover:bg-brand-gold shadow-premium",
        outline:
          "border-2 border-border bg-transparent hover:bg-surface-secondary",
        ghost:
